package com.agik.swipebutton.view;
...
import com.agik.swipebutton.controller.Swipe_Button_Controller;
import com.android.doral.R;


import static com.agik.swipebutton.util.Dimension_Util.spToPx;
import static com.agik.swipebutton.util.Drawable_Color_Util.setDrawableColor;
import static com.agik.swipebutton.util.Drawable_Color_Util.setDrawableStroke;
...
public class Swipe_Button_View extends RelativeLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    private void getAttributes(TypedArray attributes) {
        ...
        swipeTextColor = attributes.getColor(R.styleable.SwipeButtonView_sb_swipe_text_color, ContextCompat.getColor(getContext(), R.color.white));
