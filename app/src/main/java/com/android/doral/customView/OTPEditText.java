...
public class OTPEditText extends AppCompatEditText {
    ...
    public OTPEditText(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = theme.obtainStyledAttributes(attrs, R.styleable.OTPEditText, defStyleAttr, 0);

        mViewType = a.getInt(R.styleable.OTPEditText_viewType, VIEW_TYPE_RECTANGLE);
        mPinItemCount = a.getInt(R.styleable.OTPEditText_itemCount, DEFAULT_COUNT);
        mPinItemHeight = (int) a.getDimension(R.styleable.OTPEditText_itemHeight,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_size));
        mPinItemWidth = (int) a.getDimension(R.styleable.OTPEditText_itemWidth,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_size));
        mPinItemSpacing = a.getDimensionPixelSize(R.styleable.OTPEditText_itemSpacing,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_spacing));
        mPinItemRadius = (int) a.getDimension(R.styleable.OTPEditText_itemRadius, 0);
        mLineWidth = (int) a.getDimension(R.styleable.OTPEditText_lineWidth,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_line_width));
        mLineColor = a.getColorStateList(R.styleable.OTPEditText_lineColor);
        isCursorVisible = a.getBoolean(R.styleable.OTPEditText_android_cursorVisible, true);
        mCursorColor = a.getColor(R.styleable.OTPEditText_cursorColor, getCurrentTextColor());
        mCursorWidth = a.getDimensionPixelSize(R.styleable.OTPEditText_cursorWidth,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_cursor_width));

        mItemBackground = a.getDrawable(R.styleable.OTPEditText_android_itemBackground);
        mHideLineWhenFilled = a.getBoolean(R.styleable.OTPEditText_hideLineWhenFilled, false);
