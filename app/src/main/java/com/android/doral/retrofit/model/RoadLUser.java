...
public class RoadLUser implements Serializable {
    private String referral_type,latitude,longitude,start_latitude,end_longitude,first_name,last_name,status,id,color,icon;
