...
public class TimerDialogDialog extends AppCompatDialog implements View.OnClickListener {
    ...
    public TimerDialogDialog(Context context, View.OnClickListener onClickListener) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!new MyPref(context).getData(MyPref.Keys.COVID_TIME).equalsIgnoreCase("")) {
            ...
            if (System.currentTimeMillis() > Long.parseLong(new MyPref(context).getData(MyPref.Keys.COVID_TIME))) {

                new MyPref(context).setData(MyPref.Keys.COVID_TIME, "");
                dismiss();
            } else {
                long diff = Long.parseLong(new MyPref(context).getData(MyPref.Keys.COVID_TIME)) - System.currentTimeMillis();
                long diffMinutes = TimeUnit.MILLISECONDS.toSeconds(diff);

                minute = (int) diffMinutes;
