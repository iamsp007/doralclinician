...
import com.android.doral.databinding.RoadlReqItemBinding;
import com.android.doral.retrofit.model.AppontmentModel;
import java.util.ArrayList;
import java.util.List;


public class RoadLReqAdapter extends RecyclerView.Adapter<RoadLReqAdapter.MyViewHolder> implements Filterable {
    ...
    public RoadLReqAdapter(Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        RoadlReqItemBinding binding = RoadlReqItemBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        RoadlReqItemBinding binding;

        public MyViewHolder(RoadlReqItemBinding itemView) {
